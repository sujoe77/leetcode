...
public class Config {
    ...
    public void testConfig(Jedis conn) {
        ...
        config.put("db", 15);
        setConfig(conn, "com/pineapple/java/redis", "test", config);
    ...
    public Jedis redisConnection(String component) {
        ...
        String key = "config:com.pineapple.java.redis:" + component;
        Map<String, Object> oldConfig = CONFIGS.get(key);
        Map<String, Object> config = getConfig(configConn, "com/pineapple/java/redis", component);
